# Magmi Mass Update for Magento by Ali Usman
...
### Magento CE 2.x and 1.9 Support

The Magmi project needs your help!

While Magmi is being used on Magento Community Edition 2.x and 1.9 installations with very little or no issues, additional testing is required to make sure it's stable and ready for production use. Developers using Magento CE 2.x or CE 1.9.x are encouraged to provide bug reports for any issues or incompatibilities that have been discovered.
